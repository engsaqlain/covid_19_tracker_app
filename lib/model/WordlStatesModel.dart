...
class WordlStatesModel {
  ...
  WordlStatesModel.fromJson(dynamic json) {
...
WordlStatesModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WordlStatesModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
